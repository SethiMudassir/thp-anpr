package laptrinhnhung.com.ceanpr;
...
import laptrinhnhung.com.ceanpr.R;
import laptrinhnhung.com.common.PlatesListAdapter;
import laptrinhnhung.com.common.Utils;
import laptrinhnhung.com.interfaces.GPSCallback;
import laptrinhnhung.com.interfaces.OnTaskCompleted;
import laptrinhnhung.com.models.BitmapWithCentroid;
import laptrinhnhung.com.views.CameraPreview;

import laptrinhnhung.com.managers.GPSManager;
import laptrinhnhung.com.neural.KohonenNetwork;
import laptrinhnhung.com.neural.SampleData;
...
public class MainActivity extends Activity implements OnTaskCompleted, GPSCallback{
	...
	public static final String PACKAGE_NAME = "laptrinhnhung.com";
	public static final String DATA_PATH = Environment
			.getExternalStorageDirectory().toString() + "/CE-ANPR/";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Load và khởi tạo thư viện OpenCV sử dụng OpenCV Engine
		...
		if(checkOpenCV)
		{
			try {
				...
				resultOCR.setText("Welcome to CE-ANPR");
	...
	public class PlateView extends View implements Camera.PreviewCallback,
		...
		public void updateResult(String result) {
			...
			if(result!=null && !TextUtils.isEmpty(result) && result!=""){
				FileWriter f;
				try{
					f = new FileWriter(Environment.getExternalStorageDirectory() + "/CE-ANPR.txt", true);
